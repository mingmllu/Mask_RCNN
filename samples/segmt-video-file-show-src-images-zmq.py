...
# Use video_zmq_client.py on client 
...
while(True):
  ...
  if ret == True: 
    ...
    cv2.namedWindow('Source Video ... Type q to quit', cv2.WINDOW_NORMAL)
    cv2.imshow('Source Video ... Type q to quit',frame)
    cv2.resizeWindow('Source Video ... Type q to quit', 800, 600)
